...
# TF1.4
g++ -std=c++11 tf_interpolate.cpp -o tf_interpolate_so.so -shared -fPIC -I $TF_INC -I $cudainc -I$TF_INC/external/nsync/public -lcudart -L $cudalib -L$TF_LIB -ltensorflow_framework -O2
